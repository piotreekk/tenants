...
public class HouseworkControllerTest {
    ...
    public void setUp(){
        ...
        houseworkController = new HouseworkController(houseworkService, houseworkRatingService, houseworkAssembler, houseworkMapper, houseworkRatingMapper, ratingAssembler);
